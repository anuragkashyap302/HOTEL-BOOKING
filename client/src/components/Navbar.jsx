...
{/* jab bhi user login ho tabhi dashboard ke button ko dihao */}
                   { user && ( 
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    </UserButton>) : (<button onClick={openSignIn} className="bg-black hover:bg-gray-800 cursor-pointer text-white px-8 py-2.5 rounded-full ml-4 transition-all duration-500">
                        Login
                    </button>)}
