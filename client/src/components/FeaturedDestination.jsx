...
const FeaturedDestination = () => {
  ...
  return rooms.length > 0 && (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 py-20'>
      <Title title= 'Fetured Destination' subTitle= 'Discover our handpicked selection of exptional properties around the world , offering unparalleled luxury and unforgettable experiences'/>
