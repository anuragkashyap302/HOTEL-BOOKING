  ...
  return room && (
    ...
    <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
            <div className='flex flex-col'>
                ...
                <input onChange={(e) => setGuests(Number(e.target.value))} value={guests} type="number" id='guests' min="1" placeholder='1' required className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none'/>
            </div>
            
         </div>
         <button type='submit' className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
           {isAvailable ? ' Booking Available' : 'Check Availability'}
         </button>
        </form>
        ...
        <div className='mt-25 space-y-4'>
         ...
         <div>
            <p className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>Guests will be allocated on the ground floor according to avilability.
                You get a comfortable Two bedroom apartment has a true city feeling. 
                The price quoted is for two guest , at the guest slot please mark the nuber of guests to get the exact price for groups.
            </p>
         </div>
         {/* hosted by */}
         <div className='flex flex-col items-start gap-4'>
           ...
           <div>
            ...
            <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:primary-dull transition-all cursor-pointer'>Contact Now</button>
         </div>
    </div>
  )
}
