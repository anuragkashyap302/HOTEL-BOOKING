...
const AddRoom = () => {
  ...
  return (
   <form onSubmit={onSubmitHandler}>
    <Title align= 'left' font='outfit' title='Add Room' subTitle = 'Fill in the details carefully and accurate room details , pricing , and amenties, to enhance the user booking experience.'/>
    {/* uploaed area for imgage */}
     <p className='text-gray-800 mt-10'>Images</p>
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
       ...
       <h1 className='text-gray-800 mt-4 font-bold '>Amenities</h1>
        <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
         ...
         <button className='bg-indigo-500 hover:bg-indigo-600 transition-all text-white mr-auto px-8 py-2 rounded cursor-pointer mt-8' disabled = {loading}>{ loading ? 'Adding...' : 'Add Room'}</button>
   </form>
  )
}
